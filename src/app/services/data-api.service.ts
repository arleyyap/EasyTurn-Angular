...
export class DataApiService {
  ...
  public searchSistemasForEmail(email: string) {
    return this.afs.collection('TurnosIngSistemas_Tokens', ref => ref.where('email', '==', email)).snapshotChanges();
  }
  public searchMultimediaForEmail(email: string) {
    return this.afs.collection('TurnosIngMultimedia_Tokens', ref => ref.where('email', '==', email)).snapshotChanges();
  }
  public searchElectronicaForEmail(email: string) {
    return this.afs.collection('TurnosIngElectronica_Tokens', ref => ref.where('email', '==', email)).snapshotChanges();
  }
  public searchIndustrialForEmail(email: string) {
    return this.afs.collection('TurnosIngIndustrial_Tokens', ref => ref.where('email', '==', email)).snapshotChanges();
  }
  public searchAgroindustrialForEmail(email: string) {
    return this.afs.collection('TurnosIngAgro_Tokens', ref => ref.where('email', '==', email)).snapshotChanges();
  }
